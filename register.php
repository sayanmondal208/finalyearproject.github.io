...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="img/1.jpg">Maulana Abul Kalam Azad University Of TechnoLogy<br>Techno Engineering College Banipur
      <br>Banipur, Habra
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; Techno Engineering College Banipur</p>
     </footer>
 </section>
